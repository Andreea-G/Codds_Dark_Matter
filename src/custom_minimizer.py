...
TODO Generalize st more than 2 experiments can be used
"""  
...
class CustomMinimize():
    ...
    def Custom_SelfConsistent_Minimization(class_name, x0, mx, fp, fn, delta,
                                           bh_iter = 15, vmin_err = 7.0, logeta_err = 0.05,
                                           vmin_step = 15.0):
...
#            vminloglike_min = minimize(minimize_over_vmin, vmin_list, args=(logeta_list_new, class_name, mx, fp, fn, delta), method = 'SLSQP', 
#                                bounds = [(300, 900),(300, 900),(300, 900)], constraints=constr_vmin, options={'ftol': 1.0})
