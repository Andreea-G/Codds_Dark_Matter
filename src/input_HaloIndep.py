...
def Vmin_EHIBand_range(exper_name, mx, delta, mPhi=1000.):
    ...
    options = {(9., 0, 1000.): (0, 1200, 100),
               ...
               (2.2, -100, 1000.): (0, 1000, 40),
               (3., -100, 1000.): (0, 1000, 40),
               (4., -100, 1000.): (0, 1000, 40),
               (5., -100, 1000.): (0, 1200, 40),

               (1.5, -150, 1000.): (0, 1000, 40),
               (1.8, -150, 1000.): (0, 1200, 40),
               (2.2, -150, 1000.): (0, 1000, 40),

               (1.3, -180, 1000.): (0, 1000, 40),
               (1.5, -180, 1000.): (0, 1000, 40),
               }
...
input_list = [(9., 1, 0., 1000.), (9., -0.8, 0., 1000.), (9., -0.7, 0., 1000.),  # 0 - 2
              ...
              (2.2, -0.7, -150, 1000), (1.3, -0.7, -180, 1000), (1.5, -0.7, -180, 1000)] # 26-28
